...
print("\n2. Convertendo as notas para o tipo FLOAT64")
...
# =====
print("\n3. Removendo registros com dados ausentes ou inválidos nas notas")

dfCopy = dfCopy.dropna(subset=cols_notas).reset_index(drop=True)

# ==========================================================================================
print(f"\n{'='*20} DIVISÃO 1: BASE COMPLETA (80/20) {'='*20}")
# ==========================================================================================

print("\n4. Divisão da base completa em treino e teste (80/20)")
...
print("\n5. Divisão da base amostrada em treino e teste (80/20)")
